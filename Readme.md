...
- **Pet Projects:** <div style="display:flex">
                        <div style="vertical-align:top">The keyboard is the programmer's lightsaber, we're building a custom keyboard, including QMK programming for custom keybinds and led.</div>
                            <div>
